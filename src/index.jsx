...
const TableOfContents = (props) => {
	...
	return (
		<div id="intro">
			...
			<p>The Paperology x Thresholds project is a digital remediation of a handcrafted, multi-authored artisanal book. It began as an album made by Rebecca Rouse, a games researcher and creator at Skövde University in Sweden. Folded like an accordion between its brown cloth covers was a long strip of white paper, pasted with blue envelopes. Rouse had tucked scraps of different papers into the envelopes, then carefully labeled them with silver ink: Stonehenge Aqua Coldpress, Breitbahn Velouspapier, Yupo 100% Polypropylene Paper. She had also pasted three blue boxes to the back endboard, lined with marbled paper. One held a very tiny book, another a small book, and the third a large paper map, all handmade by Rouse herself. Titled paperology: an ephemeral portrait, it was an album both blank and brimming with texture, structure, and possibility – much like paper itself.</p>
			<img src="/issues/paperology/rouse-fig7.jpg" /><br/>
			<img src="/issues/paperology/rouse-fig5.jpg" /><br/>
			<p>Rebecca had had the idea for the book while participating in the Paperology Reading and Activity Group (Paperology RAG for short). This was a group of scholars, artists, and archivists that met virtually over the course of two (pandemic) years to think collectively about paper. The group was organized by Juliette De Maeyer, Aleksandra Kaminska, and Ghislain Thibault, researchers in media studies at the Université de Montréal. The Paperology meetings were based primarily on monthly discussions of thematically-organized readings, which were occasionally accompanied by special events, such as artist talks or craft activities.</p>
			...
			<p>The Paperology RAG was driven by a simple mandate—to explore paper—and energized by participants who, although geographically scattered, maintained their commitment to the group over a sustained period of time. In the process of working together month after month, we discovered and began to nurture among ourselves a shared desire to find different ways of collaborating on research and connecting across disciplines and distances. Academic “productivity” was never the end goal, although the project did produce several traditional scholarly outputs. Rather, we wanted to activate more creative modes of knowledge- and community-making. Paperology: An Ephemeral Portrait is one such example. Each contribution proposes a way of thinking about and with paper – historically, artistically, conceptually, from the perspective of literary and craft and media studies, as memoir and memory, as prosaic and political. Taken as a whole, the book shows the many directions thinking about paper can take us, as well as the many different ways research can unfold as a practice. It is networked and idiosyncratic; crafty and historical; serious and playful; collective but individually driven. Its ethos is generous, having been pieced together through our contributors’ collective goodwill, time, and openness to try new things.</p>
			<h1>⎌</h1>
			<h1>Two.</h1>
			<h2><span class="texthighlight">Remediating paper.</span></h2>
			<p>With all this already contained in the initial project, why produce a digital remediation of a paper book about paper?
			</p>
			<p>We knew this would be a difficult process. Compared to the smooth, glowing surface of a screen, paper is much more tactile. It has different textures and varying levels of opacity, thickness and malleability. It has smells and makes sounds. A book like Paperology: An Ephemeral Portrait is especially difficult to capture on a web browser not only because of the many paper varieties it contains but also because it is a book with an unusual shape, filled with static and movable appendages: things that fold out, flip, open, pop out, or exist entirely outside of the book itself. Digitizing the surface of each page through a flatbed scanner, as one might the page of a printed book, would not convey the rich dimensionality of its contents. Even photographs, staged to show the book’s dimensionality, could not capture the experience of turning its pages, pulling scraps from the envelopes, opening the many booklets stitched between its covers.
			</p>
			<p>And yet the process seemed worth attempting precisely because of its difficulties. As we know from various ventures of ours, the confrontation of paper and digital media – the transformation from one to the other – can be brutally revelatory. We suspected that the process itself would bring much about paper into sharp relief, which has always been one of the goals of this project. More, sharing this unique book on the open web would give it a wider audience of readers, who – even if they cannot touch or smell it – might still learn something about paper or about creative/critical scholarship and collaboration from its unique pages. We decided to approach the task not as if we were remediating the object itself. In other words, instead of trying to perfectly capture the content of each contribution in its entirety, we wanted to explore how to adapt the unique affordances of our handcrafted, multi-authored artisanal book for the web. 
			</p>
			<p>We approached Whitney Trettien, who co-created thresholds, a digital zine. Staged on a bespoke platform, issues of thresholds reimagine what a book might look like for a digital screen. Each article is comprised of two pages set side beside, as if the recto and verso of a book’s opening. These scroll together. To move between articles, the reader can navigate left or right, bumping one half screen at a time. In this way, the platform is designed to play with the boundaries a book’s pages in a digital space rife with different affordances and limitations. Because thresholds is already imagining the relationship between the page and screen, between codex and accordion, it seemed an apt platform for remediating Paperology: An Ephemeral Portrait. 
			</p>
			<p>At the start of our collaboration, we approached all of the contributors with our concept and asked them to reflect back on their own participation in the project. To spur on their reflections, we provided a list of open-ended questions, like:
			</p>
			<ul>
