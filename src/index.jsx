...
const TableOfContents = (props) => {
	...
	return (
		<div id="intro">
			...
			<p>Rebecca had had the idea for the book while participating in the <a href="https://paperology.site/" target="_blank">Paperology Reading and Activity Group</a> (Paperology RAG for short). This was a group of scholars, artists, and archivists that met virtually over the course of two (pandemic) years to think collectively about paper. The group was organized by Juliette De Maeyer, Aleksandra Kaminska, and Ghislain Thibault, researchers in media studies at the Université de Montréal. The Paperology meetings were based primarily on monthly discussions of thematically-organized readings, which were occasionally accompanied by special events, such as artist talks or craft activities.
			</p>
			...
			<p>The book finally arrived in Montréal on the eve of the Paperology Symposium, an in-person event that featured many Paperologists and contributors to the book. Finally, and together, we saw the book. It had completed its journey.</p>
